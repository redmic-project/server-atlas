...
public class UpdateThemeInspireCancelledEvent extends ThemeInspireCancelledEvent {

	// @formatter:off

	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{"
		+ "\"type\":\"record\",\"name\":\"UpdateThemeInspireCancelledEvent\","
	...
	static String type = ThemeInspireEventTypes.UPDATE_CANCELLED;

	public UpdateThemeInspireCancelledEvent() {
		super(type);
	}

	public UpdateThemeInspireCancelledEvent(ThemeInspireDTO themeInspire) {
		super(type);
