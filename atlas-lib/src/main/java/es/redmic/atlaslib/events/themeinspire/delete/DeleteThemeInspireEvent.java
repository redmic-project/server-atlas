...
public class DeleteThemeInspireEvent extends SimpleEvent {

	// @formatter:off

	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{"
		+ "\"type\":\"record\",\"name\":\"DeleteThemeInspireEvent\","
				+ "\"namespace\":\"es.redmic.atlaslib.events.themeinspire.delete\",\"fields\":["
			+ getEventBaseSchema() + "]}");
	// @formatter:on

	static String type = ThemeInspireEventTypes.DELETE;

	public DeleteThemeInspireEvent() {
		super(type);
