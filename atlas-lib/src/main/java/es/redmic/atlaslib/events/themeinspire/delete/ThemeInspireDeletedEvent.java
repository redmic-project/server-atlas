...
public class ThemeInspireDeletedEvent extends SimpleEvent {

	// @formatter:off

	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{"
		+ "\"type\":\"record\",\"name\":\"ThemeInspireDeletedEvent\","
				+ "\"namespace\":\"es.redmic.atlaslib.events.themeinspire.delete\",\"fields\":["
			+ getEventBaseSchema() + "]}");
	// @formatter:on

	static String type = ThemeInspireEventTypes.DELETED;

	public ThemeInspireDeletedEvent() {
		super(type);
	}
