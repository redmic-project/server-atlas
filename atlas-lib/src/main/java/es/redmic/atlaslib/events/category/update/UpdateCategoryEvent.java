...
public class UpdateCategoryEvent extends CategoryEvent {

	// @formatter:off

	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{"
		+ "\"type\":\"record\",\"name\":\"UpdateCategoryEvent\","
				+ "\"namespace\":\"es.redmic.atlaslib.events.category.update\",\"fields\":["
			+ getCategoryEventSchema() + ","
			+ getEventBaseSchema() + "]}");
	// @formatter:on

	static String type = CategoryEventTypes.UPDATE;
	...
	public UpdateCategoryEvent(CategoryDTO category) {
		super(type);
