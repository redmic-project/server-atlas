...
public class ThemeInspireUpdatedEvent extends ThemeInspireEvent {

	// @formatter:off

	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{"
		+ "\"type\":\"record\",\"name\":\"ThemeInspireUpdatedEvent\","
				+ "\"namespace\":\"es.redmic.atlaslib.events.themeinspire.update\",\"fields\":["
			+ getThemeInspireEventSchema() + ","
			+ getEventBaseSchema() + "]}");
	// @formatter:on

	static String type = ThemeInspireEventTypes.UPDATED;

	public ThemeInspireUpdatedEvent() {
		super(type);
	}

	public ThemeInspireUpdatedEvent(ThemeInspireDTO themeInspire) {
		super(type);
