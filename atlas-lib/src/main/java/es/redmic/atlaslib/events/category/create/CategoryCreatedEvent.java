...
public class CategoryCreatedEvent extends CategoryEvent {
	...
	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser()
			.parse("{" + "\"type\":\"record\",\"name\":\"CategoryCreatedEvent\","
					+ "\"namespace\":\"es.redmic.atlaslib.events.category.create\",\"fields\":["
					+ getCategoryEventSchema() + "," + getEventBaseSchema() + "]}");
	// @formatter:on

	static String type = CategoryEventTypes.CREATED;

	public CategoryCreatedEvent() {
		super(type);
	}

	public CategoryCreatedEvent(CategoryDTO category) {
		super(type);
