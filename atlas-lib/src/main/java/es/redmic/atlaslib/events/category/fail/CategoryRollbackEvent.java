package es.redmic.atlaslib.events.category.fail;
...
public class CategoryRollbackEvent extends BaseRollbackEvent {
	...
	private CategoryDTO lastSnapshotItem;

	public CategoryRollbackEvent() {
		super(type);
	}

	public CategoryDTO getLastSnapshotItem() {
		return lastSnapshotItem;
	}

	public void setLastSnapshotItem(CategoryDTO lastSnapshotItem) {
	...
	public void put(int field$, Object value$) {
		switch (field$) {
		case 0:
			setLastSnapshotItem((CategoryDTO) value$);
			break;
		case 1:
