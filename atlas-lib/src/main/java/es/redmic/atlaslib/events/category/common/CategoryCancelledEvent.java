package es.redmic.atlaslib.events.category.common;
...
public abstract class CategoryCancelledEvent extends EventError {
	...
	@JsonIgnore
	public static String getCategoryEventSchema() {

		return "{\"name\":\"category\", \"type\": " + CategoryDTO.SCHEMA$.toString() + "}";
	}
}
