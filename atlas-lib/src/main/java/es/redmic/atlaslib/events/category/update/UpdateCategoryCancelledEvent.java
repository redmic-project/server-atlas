...
public class UpdateCategoryCancelledEvent extends CategoryCancelledEvent {

	// @formatter:off

	public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{"
		+ "\"type\":\"record\",\"name\":\"UpdateCategoryCancelledEvent\","
	...
	static String type = CategoryEventTypes.UPDATE_CANCELLED;

	public UpdateCategoryCancelledEvent() {
		super(type);
	}

	public UpdateCategoryCancelledEvent(CategoryDTO themeInspire) {
		super(type);
